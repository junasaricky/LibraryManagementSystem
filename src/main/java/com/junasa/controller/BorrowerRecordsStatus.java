...
@WebServlet("/BorrowerRecordsStatus")
public class BorrowerRecordsStatus extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("borrower-records-status.jsp").forward(request, response);
	}
}
