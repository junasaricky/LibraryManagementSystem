...
@WebServlet("/BorrowerViewBooks")
public class BorrowerViewBooks extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getRequestDispatcher("borrower-view-books.jsp").forward(request, response);
	}
