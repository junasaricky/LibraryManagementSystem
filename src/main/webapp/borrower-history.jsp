...
<body>
	<div class="hero_area">
		...
		<section class="book_section layout_padding">
  			<div class="container">
    			<div class="mb-3">
      				<p class="text-muted" style="margin: 0;">My Records  &gt; <strong>Borrower's History</strong></p>
    			</div>
      				...
      				<table id="statusTable" class="table table-bordered table-striped">
        				...
        				<tbody>
				          <%
				            ...
				            ResultSet rs = dao.getBorrowerHistoryByUsername(username);
				            int count = 0;
  		...
  		<%
			request.setAttribute("currentPage", "BorrowerHistory");
		%>
