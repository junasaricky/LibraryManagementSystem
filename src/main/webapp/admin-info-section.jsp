        ...
        <div class="col-md-6 col-lg-3">
          <div class="info_links">
            ...
            <div class="info_links_menu">
              <a class="${currentPage == 'AdminHome' ? 'active' : ''}" href="AdminHome">Home</a>
              <a class="${currentPage == 'ViewBooks' ? 'active' : ''}" href="ViewBooks">View Books</a>
              <a class="${currentPage == 'AddBookForm' ? 'active' : ''}" href="AddBookForm">Add Books</a>
              <a class="${currentPage == 'BorrowerStatus' ? 'active' : ''}" href="BorrowerStatus">Borrower Status</a>
              <a class="${currentPage == 'AdminProfile' ? 'active' : ''}" href="AdminProfile">Admin Profile</a>
              <a class="${currentPage == 'BorrowerProfile' ? 'active' : ''}" href="BorrowerProfile">Borrower Profile</a>
            </div>
          </div>
        </div>
