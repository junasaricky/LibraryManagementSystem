	...
	%>
  	...
  	<div class="hero_area">
    	...
    	<%
	        ...
	        int totalBorrowedBooks = dao.countBorrowedBooks(userId);
	        int totalOverdueBooks = dao.countOverdueBooks(userId);
		 %>
        	<div class="container">
  	...
  	<%
		request.setAttribute("currentPage", "BorrowerHome");
	%>
	...
	<div class="modal fade" id="changePasswordModal" tabindex="-1" role="dialog" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
  		<div class="modal-dialog" role="document">
    		<form action="ChangePasswordServlet" method="post">
      			<input type="hidden" name="source" value="BorrowerHome">
