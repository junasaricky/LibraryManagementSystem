...
<body>
	<div class="hero_area">
    	...
    	<section class="book_section layout_padding">
  			<div class="container">
    			<div class="mb-3">
      				<p class="text-muted" style="margin: 0;">My Records  &gt; <strong>Borrower's Status</strong></p>
    			</div>
      				...
      				<table id="statusTable" class="table table-bordered table-striped">
        				...
        				<tbody>
				          <%
					        ...
					        ResultSet rs = dao.getBorrowedBooksByUser(username);
				            int count = 0;
				          ...
				          %>
          					<tr>
					            ...
					            <td>
					              <%= (rs.getString("return_date") != null && !"".equals(rs.getString("return_date"))) 
  		...
  		<section class="team_section layout_padding">
    		<div class="container">
  			...
  			<%
				request.setAttribute("currentPage", "BorrowerRecordsStatus");
			%>
		...
		<div class="modal fade" id="changePasswordModal" tabindex="-1" role="dialog" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
  			<div class="modal-dialog" role="document">
	    		<form action="ChangePasswordServlet" method="post">
	     			<input type="hidden" name="source" value="BorrowerRecordsStatus">
