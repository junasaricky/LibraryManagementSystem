	...
	<div class="hero_area">
    	...
    	<section class="book_section layout_padding">
      		<div class="container">
        		<!-- Breadcrumb / Path -->
        		<div class="mb-3">
          			<p class="text-muted" style="margin: 0;">Book Management &gt; <strong>Add Books</strong></p>
        		</div>
        		<div class="row">
          			<div class="col">
            			<form action="AddBook" method="post">
              				...
              				<div class="form-row ">
	                			...
	                			<div class="form-group col-lg-4">
	                  				<label>Author</label>
	                  				<input type="text" class="form-control" placeholder="" name="author" required>
	                			</div>
	                			<div class="form-group col-lg-4">
	                  				<label>Publisher</label>
	                  				<input type="text" class="form-control" placeholder="" name="publisher" required>
	                			</div>
              				</div>
              				<div class="form-row ">
                				<div class="form-group col-lg-4">
                				...
                				<div class="form-group col-lg-4">
                  					...
                  					<input type="number" class="form-control" min="1" placeholder="Enter quantity" name="quantity" required>
                				</div>
                				<div class="form-group col-lg-4">
                  					<label>Image</label>
  		...
  		<section class="team_section layout_padding">
    		<div class="container">
      			<div class="heading_container heading_center">
        			<h2>
          				Recently Added <span>Books</span>
        			</h2>
      			</div>
      			<div class="carousel-wrap ">
			        ...
			        ResultSet rs = dao.getRecentlyAddedBooks();
				    while(rs.next()){
				 	%>
          				<div class="item">
            				<div class="box">
  		...
  		<%
    	request.setAttribute("currentPage", "AddBookForm");
		%>
		...
		<div class="modal fade" id="changePasswordModal" tabindex="-1" role="dialog" aria-labelledby="changePasswordModalLabel" aria-hidden="true">
  			<div class="modal-dialog" role="document">
    			<form action="ChangePasswordServlet" method="post">
      				<input type="hidden" name="source" value="AddBookForm">
