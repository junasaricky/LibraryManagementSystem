  	...
  	<div class="hero_area">
    	...
    	<section class="book_section layout_padding">
      		<div class="container">
        		<!-- Breadcrumb / Path -->
        		<div class="mb-3">
          			<p class="text-muted" style="margin: 0;">Account Setting  &gt; <strong>Admin</strong></p>
        		</div>
        		<div class="table-responsive">
          			<table id="statusTable" class="table table-bordered table-striped">
		        		...
		        		User_Dao dao = new User_Dao();
		              	...
		              	ResultSet rs = dao.getAdminData(username);
					    int count = 0;
  		...
  		<!-- end team section -->
		<%
	    request.setAttribute("currentPage", "AdminProfile");
		%>
